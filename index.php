...
<style>
    ...
    .pricing-card.featured {
        ...
        position: relative;
        background: linear-gradient(180deg, var(--brand-50) 0%, white 40%);
    }
...
<section class="hero">
    <div class="hero-content animate-fade-in">
        ...
        <p>Analitik penjualan, arus kas, dan performa produk Anda — langsung dari data transaksi SmartBank. Ambil
            keputusan bisnis yang lebih cerdas.</p>
        <div class="flex gap-4 justify-center flex-wrap">
            <a href="register.php"
                class="btn btn-primary btn-lg px-10 py-4 text-lg shadow-xl hover:-translate-y-1 hover:shadow-2xl transition-all duration-300"><i
                    class="ph ph-rocket-launch"></i> Daftar Gratis</a>
            <a href="login.php"
                class="btn btn-lg px-10 py-4 text-lg shadow-xl hover:-translate-y-1 hover:shadow-2xl transition-all duration-300"
                style="background-color: white !important; color: #0d9488 !important; border: none;"><i
                    class="ph ph-sign-in"></i> Masuk</a>
        </div>
    </div>
</section>
...
<section class="section" id="fitur">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="card p-8 hover:-translate-y-2 transition-transform">
            <div
                class="w-14 h-14 rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center text-2xl mb-6">
                <i class="ph-fill ph-trend-up"></i></div>
            <h3 class="text-lg font-bold mb-3">Laporan Penjualan</h3>
            <p class="text-sm text-slate-500 leading-relaxed">Pantau tren pendapatan harian hingga bulanan. Identifikasi
                kanal penjualan paling produktif untuk bisnis Anda.</p>
        </div>
        <div class="card p-8 hover:-translate-y-2 transition-transform">
            <div class="w-14 h-14 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center text-2xl mb-6">
                <i class="ph-fill ph-money"></i></div>
            <h3 class="text-lg font-bold mb-3">Arus Kas (Cashflow)</h3>
            <p class="text-sm text-slate-500 leading-relaxed">Pahami aliran dana masuk dan keluar secara mendalam.
                Pantau pengeluaran stok, operasional, hingga pajak.</p>
        </div>
        <div class="card p-8 hover:-translate-y-2 transition-transform">
            <div
                class="w-14 h-14 rounded-2xl bg-amber-50 text-amber-600 flex items-center justify-center text-2xl mb-6">
                <i class="ph-fill ph-package"></i></div>
            <h3 class="text-lg font-bold mb-3">Performa Produk</h3>
            <p class="text-sm text-slate-500 leading-relaxed">Ketahui produk "Star" dan "Slow Mover" Anda. Optimalkan
                stok berdasarkan data preferensi konsumen nyata.</p>
        </div>
    </div>
</section>
    ...
    <div class="max-w-[1200px] mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div class="card p-10 flex flex-col">
                ...
                <div class="text-3xl font-black my-4">Rp 0<span class="text-sm font-normal text-slate-400">/bulan</span>
                </div>
                <ul class="space-y-4 mb-10 flex-1">
                    <li class="flex items-center gap-2 text-sm text-slate-600"><i
                            class="ph-fill ph-check-circle text-brand-500"></i> Dashboard Dasar</li>
                    <li class="flex items-center gap-2 text-sm text-slate-600"><i
                            class="ph-fill ph-check-circle text-brand-500"></i> Laporan 3 Bulan Terakhir</li>
                    <li class="flex items-center gap-2 text-sm text-slate-600"><i
                            class="ph-fill ph-check-circle text-brand-500"></i> Top 5 Produk Terlaris</li>
            ...
            <div class="card p-10 flex flex-col featured border-brand-500">
                ...
                <div class="text-3xl font-black my-4">Rp 99K<span
                        class="text-sm font-normal text-slate-400">/bulan</span></div>
                <ul class="space-y-4 mb-10 flex-1">
                    <li class="flex items-center gap-2 text-sm text-slate-600"><i
                            class="ph-fill ph-check-circle text-brand-500"></i> Semua Fitur Free</li>
                    <li class="flex items-center gap-2 text-sm text-slate-600"><i
                            class="ph-fill ph-check-circle text-brand-500"></i> Laporan Sejarah Tanpa Batas</li>
                    <li class="flex items-center gap-2 text-sm text-slate-600"><i
                            class="ph-fill ph-check-circle text-brand-500"></i> Proyeksi Arus Kas Mendatang</li>
                    <li class="flex items-center gap-2 text-sm text-slate-600"><i
                            class="ph-fill ph-check-circle text-brand-500"></i> Analisis Pertumbuhan Lanjutan</li>
                    <li class="flex items-center gap-2 text-sm text-slate-600"><i
                            class="ph-fill ph-check-circle text-brand-500"></i> Export CSV & PDF</li>
                </ul>
                <a href="register.php"
                    class="btn btn-primary btn-full py-4 font-bold shadow-lg shadow-brand-200">Beralih ke Pro</a>
            </div>
        </div>
    </div>
</section>
...
<footer class="bg-slate-950 text-white py-12 px-6 text-center border-t border-slate-800">
    ...
    <p class="text-slate-500 text-xs">&copy; <?php echo date('Y'); ?> Ekosistem Ekonomi UMKM. Simulasi Sistem Informasi
        RPL 2.</p>
</footer>
